...
function getDOB() {
	...
	// Calculating the Age
	if (yearDiff < 0) console.log("Điền sai năm rồi điền lại đê");
	else if (monthDiff > 0) {
	...
	if (yearDiff < 0)
		document.getElementById("currentAge").innerHTML = "Cậu điền sai rồi cậu định lừa ai???";
	else
		document.getElementById("currentAge").innerHTML =
			"Ừ để tớ đoán nhé, hiện giờ cậu " + yearDiff + " tuổi &#x1F603;"
