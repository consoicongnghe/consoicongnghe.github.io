...
/** DISK AVOIDANCE ***/
user_pref("browser.cache.disk.enable", true); // changed for convenience
...
user_pref("browser.search.suggest.enabled", true); // changed
user_pref("browser.urlbar.quicksuggest.enabled", true); // changed
...
/** HEADERS / REFERERS ***/
user_pref("network.http.referer.XOriginTrimmingPolicy", 2); // if SSO logins fail, remove this
...
/** MOZILLA ***/
user_pref("permissions.default.desktop-notification", 0); // PREF: site notifications. 0/1/2 = Ask/Allow/Never
user_pref("permissions.default.geo", 0); // PREF: ask you for your location. 0/1/2 = Ask/Allow/Never
...
user_pref("nglayout.initialpaint.delay_in_oopif", 15);
...
// PREF: Enable Hardware Acceleration fully
user_pref("layers.acceleration.force-enabled", true);
user_pref("gfx.webrender.all", true);
user_pref("gfx.webrender.compositor", true);

// PREF: Process Priority
user_pref("dom.ipc.processCount", 16); // for systems with 16+ GB RAM
